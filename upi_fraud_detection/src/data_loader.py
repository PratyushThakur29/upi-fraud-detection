...
class DataLoader:
    ...
    def preprocess(self, test_size=0.2, random_state=42, apply_smote=True):
        ...
        # Define feature columns (exclude id and target) - case insensitive
        exclude_cols = ['id', 'upi_number', self.target_col]
        feature_cols = [col for col in self.df.columns 
                       if col.lower() not in [c.lower() for c in exclude_cols] and col != self.target_col]
